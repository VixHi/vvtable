...
- (void) configure:(UITableViewHeaderFooterView *) view model:(id) model indexPath:(NSInteger) section {
//    VBaseModel *baseModel = model;
    self.textLabel.text = [NSString stringWithFormat:@"section:%ld", section];
}
